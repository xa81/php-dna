...
trait SharedApiConfigAndUtilsTrait
{
     ...
     */
    public static $VERSION = '2.1.14'; // Bu değer her iki sınıfta da aynı olmalı, gerekirse güncellenmeli
    ...
    private function sendErrorToSentryAsync(Exception $e): void
    {
        ...
        $errorData = [
            ...
            'exception' => [
                'values' => [
                    [
                        'type'       => str_replace(['DomainNameApi\\DNARest', 'DomainNameApi\\DomainNameAPI_PHPLibrary'], [$this->application . ' Exception', $this->application . ' Exception'], $culpritClass),
                        'value'      => $e->getMessage(),
                        'stacktrace' => [
                            'frames' => [
                                [
